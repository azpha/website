...
export default function App() {
  ...
  return (
    <Layout>
      ...
      <div className="my-2">
        <div className="border border-white border-solid p-2 rounded-lg mb-4 flex justify-between">
        ...
        <div className="border border-white border-solid rounded-lg p-2 my-4">
          <div className="flex flex-wrap justify-between p-2">
            <div>
              <h1 className="text-2xl font-bold italic opacity-95">alex, 18</h1>
              <ScrollingText text={lyric ? lyric.string : ""} />
              <img
